...
const quotes = [
  ...
  "Okupasi Pemprogaman junior",
  "sykanya ngode doang gak langsung action",
  "Tetap harus belajar,ingat di dunia industri kamu hanyalah ikan teri diantara megalodon",
  "Manfaatkan sisa waktu yang ada,suatu hari pasti akan kamu kenang",
  "Programmer hebat bukan yang tidak pernah salah, tetapi yang tahu cara memperbaiki kesalahan",
  "IT mengajarkan bahwa kegagalan hanyalah versi beta dari keberhasilan",
  "Update diri lebih penting daripada update perangkat",
  "Keyboard adalah senjata, ilmu adalah kekuatan",
  "Orang yang terus belajar akan selalu punya tempat di era digital",
  "Jangan hanya jadi pengguna teknologi, jadilah pencipta teknologi",
  "Di balik aplikasi hebat, ada proses panjang penuh revisi",
  "Orang pintar membuat program, orang bijak membuat program yang berguna",
  "Jika ingin sukses di IT, biasakan mencari solusi sebelum mengeluh",
  "Orang sabar akan menang di dunia IT, karena bug tidak selesai dengan emosi",
  "Teknologi selalu berubah, maka berhenti belajar berarti tertinggal",
  "Skill IT tidak datang dari teori saja, tetapi dari praktik tanpa henti",
  "Dunia digital menghargai kemampuan, bukan sekadar gelar",
  "Satu skill digital bisa membuka seribu peluang",
  "Masa depan tidak ditunggu, tetapi dibangun dengan ilmu dan teknologi",
  "Consistency beats intensity in mastering IT",
  "Every delay in learning today becomes regret tomorrow",
  "The smartest people are often the ones still asking questions",
  "Progress starts when excuses end",
  ...
  "Programmer hebat bukan yang menulis banyak kode, tapi yang menghapus kode tak perlu",
  "setiap error message adalah petunjuk, bukan hinaan",
  "UX buruk adalah bug yang tidak tertulis",
  "Setiap klik pengguna adalah bentuk kepercayaan",
  "Data analyst tidak menebak, ia membuktikan",
  "Angka bisa jujur, tapi interpretasi bisa salah",
  "Data mentah hanyalah batu, insight adalah pahatan",
  "Grafik indah tanpa makna hanyalah dekorasi",
  "Pertanyaan yang tepat lebih penting dari dataset besar",
  "Spreadsheet rapi adalah tanda pikiran rapi",
  "Statistik tanpa konteks bisa menipu",
  "Data kecil yang akurat lebih baik dari data besar yang kacau",
  "FPS tinggi kadang lebih penting dari grafis tinggi",
  "Balancing adalah seni antara adil dan menyenangkan",
  "Update kecil bisa menghidupkan komunitas besar",
  "Belajar debugging adalah belajar berpikir jernih",
  "Tidak semua yang bisa diotomasi perlu diotomasi",
  "Programmer pemula fokus syntax, profesional fokus solusi",
  "Waktu tercepat memperbaiki bug adalah sebelum bug dibuat",
  "Teknologi baru menarik, fondasi lama menyelamatkan",
  "Banyak project gagal bukan karena kode, tapi komunikasi",
  "Engineer terbaik tahu kapan membangun dan kapan menyederhanakan",
  "Desain indah kalah oleh loading lambat",
  "Web developer tidak hanya membuat tampilan, tapi pengalaman",
  "Frontend terlihat pengguna, backend terasa dampaknya",
  "Refactor kecil hari ini mencegah rewrite besar nanti",
  "Situs sederhana yang jelas lebih baik dari situs mewah yang membingungkan",
  "Data mentah hanyalah batu, insight adalah pahatan",
  "Seorang analyst hebat mendengar cerita di balik angka",
  "Gameplay menang atas visual jika hati pemain terlibat",
  "Orang pintar menyelesaikan masalah, engineer mencegahnya datang lagi",
  "Teknologi berubah cepat, prinsip bertahan lama",
  "Skill tumbuh saat ego mengecil",
  "Sistem kompleks sering lahir dari solusi sederhana yang diulang",
  "Kerja tim lebih penting dari hero coding semalam suntuk",
  "Versi pertama dibuat untuk berjalan, versi berikutnya dibuat untuk bertahan",
  "Semakin senior seseorang, semakin hati-hati ia menambah kompleksitas",
  "Coding bukan soal mengetik cepat, tapi berpikir tepat",
